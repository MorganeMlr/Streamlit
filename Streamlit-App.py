...
if page == pages[6] : 
    ...
    st.markdown("<h5><span style='color: #27DCE0;'>La géographie</span> influence les inégalités de salaire dans la mesure où il est possible de regrouper les départements métropolitains et les villes dans trois groupes bien définis répartis inégalement sur le territoire.</h5>", unsafe_allow_html=True)
